...
public final class NonSI extends SystemOfUnits {
    ...
    /**
     * A dimensionless unit equals to <code>0.01</code> (standard name <code>%</code>).
     */
     ...
     */
    public static final Unit<Dimensionless> DECIBEL = nonSI(Unit.ONE.transform(new LogConverter(10).inverse()
                                                                                                   .concatenate(new RationalConverter(1,
                                                                                                                                      10))));
    ...
    /**
     * A unit of amount of substance equals to one atom (standard name <code>atom</code>).
     */
    ...
    /**
     * A unit of length equal to <code>1E-10 m</code> (standard name <code>Å</code>).
     */
    public static final Unit<Length> ANGSTROM = nonSI(METRE.divide(10000000000L));

    /**
     * A unit of length equal to the average distance from the center of the Earth to the center of the Sun (standard
     * name <code>ua</code>).
     */
    ...
    /**
     * A unit of length equal to the distance at which a star would appear to shift its position by one arcsecond over
     * the course the time (about 3 months) in which the Earth moves a distance of {@link #ASTRONOMICAL_UNIT} in the
     * direction perpendicular to the direction to the star (standard name <code>pc</code>).
     */
    ...
    /**
     * A unit of duration equal to <code>60 s</code> (standard name <code>min</code>).
     */
    ...
    /**
     * A unit of duration equal to <code>7 {@link #DAY}</code> (standard name <code>week</code>).
     */
    public static final Unit<Duration> WEEK = nonSI(DAY.times(7));

    /**
     * A unit of duration equal to 365 days, 5 hours, 49 minutes, and 12 seconds (standard name <code>year</code>).
     */
    public static final Unit<Duration> YEAR = nonSI(SECOND.times(31556952));

    /**
     * A unit of duration equal to one twelfth of a year (standard name <code>month</code>).
     */
    public static final Unit<Duration> MONTH = nonSI(YEAR.divide(12));

    /**
     * A unit of duration equal to the time required for a complete rotation of the earth in reference to any star or to
     * the vernal equinox at the meridian, equal to 23 hours, 56 minutes, 4.09 seconds (standard name
     * <code>day_sidereal</code>).
     */
    public static final Unit<Duration> DAY_SIDEREAL = nonSI(SECOND.times(86164.09));

    /**
     * A unit of duration equal to one complete revolution of the earth about the sun, relative to the fixed stars, or
     * 365 days, 6 hours, 9 minutes, 9.54 seconds (standard name <code>year_sidereal</code>).
     */
    public static final Unit<Duration> YEAR_SIDEREAL = nonSI(SECOND.times(31558149.54));

    /**
     * A unit of duration equal to <code>365 {@link #DAY}</code> (standard name <code>year_calendar</code>).
     */
    ...
    /**
     * A unit of mass equal to 1/12 the mass of the carbon-12 atom (standard name <code>u</code>).
     */
    public static final Unit<Mass> ATOMIC_MASS = nonSI(KILOGRAM.times(1e-3 / AVOGADRO_CONSTANT));

    /**
     * A unit of mass equal to the mass of the electron (standard name <code>me</code>).
     */
     ...
     */
    public static final Unit<Mass> POUND = nonSI(KILOGRAM.times(AVOIRDUPOIS_POUND_DIVIDEND)
                                                         .divide(AVOIRDUPOIS_POUND_DIVISOR));
    ...
    /**
     * A unit of mass equal to <code>2000 {@link #POUND}</code> (short ton, standard name <code>ton_us</code>).
     */
    public static final Unit<Mass> TON_US = nonSI(POUND.times(2000));

    /**
     * A unit of mass equal to <code>2240 {@link #POUND}</code> (long ton, standard name <code>ton_uk</code>).
     */
    public static final Unit<Mass> TON_UK = nonSI(POUND.times(2240));

    /**
     * A unit of mass equal to <code>1000 kg</code> (metric ton, standard name <code>t</code>).
     */
    ...
    /**
     * A unit of electric charge equal to the charge on one electron (standard name <code>e</code>).
     */
    public static final Unit<ElectricCharge> E = nonSI(COULOMB.times(ELEMENTARY_CHARGE));

    /**
     * A unit of electric charge equal to equal to the product of Avogadro's number (see {@link SI#MOLE}) and the charge
     * (1 e) on a single electron (standard name <code>Fd</code>).
     */
    ...
    /**
     * A unit of velocity expressing the number of international {@link #MILE miles} per {@link #HOUR hour}
     * (abbreviation <code>mph</code>).
     */
    public static final Unit<Velocity> MILES_PER_HOUR = nonSI(NonSI.MILE.divide(NonSI.HOUR)).asType(Velocity.class);

    /**
     * A unit of velocity expressing the number of {@link SI#KILOMETRE} per {@link #HOUR hour}.
     */
    public static final Unit<Velocity> KILOMETRES_PER_HOUR = nonSI(SI.KILOMETRE.divide(NonSI.HOUR)).asType(Velocity.class);
    ...
    /**
     * A unit of velocity expressing the number of {@link #NAUTICAL_MILE nautical miles} per {@link #HOUR hour}
     * (abbreviation <code>kn</code>).
     */
    public static final Unit<Velocity> KNOT = nonSI(NonSI.NAUTICAL_MILE.divide(NonSI.HOUR)).asType(Velocity.class);
    ...
    /**
     * A unit of velocity relative to the speed of light (standard name <code>c</code>).
     */
    ...
    /**
     * A unit of acceleration equal to the gravity at the earth's surface (standard name <code>grav</code>).
     */
    public static final Unit<Acceleration> G = nonSI(METRES_PER_SQUARE_SECOND.times(STANDARD_GRAVITY_DIVIDEND)
    ...
    /**
     * A unit of data amount equal to <code>8 {@link SI#BIT}</code> (BinarY TErm, standard name <code>byte</code>).
     */
    ...
    /**
     * A unit of electric charge equal to the centimeter-gram-second electromagnetic unit of magnetomotive force, equal
     * to <code>10/4
     * &pi;ampere-turn</code> (standard name <code>Gi</code>).
     */
    public static final Unit<ElectricCurrent> GILBERT = nonSI(SI.AMPERE.times(10.0 / (4.0 * Math.PI)));
    ...
    /**
     * A unit of energy equal to one electron-volt (standard name <code>eV</code>, also recognized
     * <code>keV, MeV, GeV</code>).
     */
    public static final Unit<Energy> ELECTRON_VOLT = nonSI(JOULE.times(ELEMENTARY_CHARGE));

    /**
     * A unit of energy equal to <code>3.6E6 J</code> (standard name <code>KiloWattHour</code>).
     */
    public static final Unit<Energy> KWH = nonSI(SI.JOULE.times(60 * 60 * 1000));
    ...
    /**
     * A unit of illuminance equal to <code>1E4 Lx</code> (standard name <code>La</code>).
     */
    ...
    /**
     * A unit of magnetic flux equal <code>1E-8 Wb</code> (standard name <code>Mx</code>).
     */
    ...
    /**
     * A unit of magnetic flux density equal <code>1000 A/m</code> (standard name <code>G</code>).
     */
    ...
    /**
     * A unit of force equal to <code>9.80665 N</code> (standard name <code>kgf</code>).
     */
    public static final Unit<Force> KILOGRAM_FORCE = nonSI(NEWTON.times(STANDARD_GRAVITY_DIVIDEND)
                                                                 .divide(STANDARD_GRAVITY_DIVISOR));

    /**
     * A unit of force equal to <code>{@link #POUND}·{@link #G}</code> (standard name <code>lbf</code>).
     */
    public static final Unit<Force> POUND_FORCE = nonSI(NEWTON.times(1L * AVOIRDUPOIS_POUND_DIVIDEND
                                                                     * STANDARD_GRAVITY_DIVIDEND)
                                                              .divide(1L * AVOIRDUPOIS_POUND_DIVISOR
    ...
    /**
     * A unit of power equal to the power required to raise a mass of 75 kilograms at a velocity of 1 meter per second
     * (metric, standard name <code>hp</code>).
     */
    ...
    /**
     * A unit of pressure equal to <code>100 kPa</code> (standard name <code>bar</code>).
     */
     ...
     */
    public static final Unit<Pressure> MILLIMETER_OF_MERCURY = nonSI(PASCAL.times(133.322));
    ...
    /**
     * A unit of radiation dose absorbed equal to a dose of 0.01 joule of energy per kilogram of mass (J/kg) (standard
     * name <code>rd</code>).
     */
    public static final Unit<RadiationDoseAbsorbed> RAD = nonSI(GRAY.divide(100));

    /**
     * A unit of radiation dose effective equal to <code>0.01 Sv</code> (standard name <code>rem</code>).
     */
    ...
    /**
     * A unit of radioctive activity equal to the activity of a gram of radium (standard name <code>Ci</code>).
     */
    ...
    /**
     * A unit of solid angle equal to <code>4 <i>&pi;</i> steradians</code> (standard name <code>sphere</code>).
     */
    public static final Unit<SolidAngle> SPHERE = nonSI(STERADIAN.times(4.0 * Math.PI));
    ...
    /**
     * A unit of volume equal to one cubic decimeter (default label <code>L</code>, also recognized
     * <code>µL, mL, cL, dL</code>).
     */
    ...
    /**
     * A unit of volume equal to one US gallon, Liquid Unit. The U.S. liquid gallon is based on the Queen Anne or Wine
     * gallon occupying 231 cubic inches (standard name <code>gal</code>).
     */
    public static final Unit<Volume> GALLON_LIQUID_US = nonSI(CUBIC_INCH.times(231));

    /**
     * A unit of volume equal to <code>1 / 128 {@link #GALLON_LIQUID_US}</code> (standard name <code>oz_fl</code>).
     */
    ...
    /**
     * A unit used to measure the ionizing ability of radiation (standard name <code>Roentgen</code>).
     */
